...
class Settings:
    ...
    RESOURCE_API_GATEWAY_NAME = os.environ.get("RESOURCE_API_GATEWAY_NAME", "ApiGateway")
    RESOURCE_BUCKET_ID = os.environ.get("RESOURCE_BUCKET_ID", "AwsCdkArchitectureBucket")
    ...
    RESOURCE_STACK_DEPLOY_NAME = os.environ.get("RESOURCE_STACK_DEPLOY_NAME", "AwsCdkResourceStackDeploy")
